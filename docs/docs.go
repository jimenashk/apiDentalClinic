...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "API Support.",
            "url": "https://github.com/jimena_shk"
        },
        "license": {
            "name": "Apache 2.0",
    ...
    "paths": {
        ...
        "/appointments": {
            ...
            "post": {
                "description": "Post a appointment",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    {
                        "description": "appointment to data",
                        "name": "dentist",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.appointmentInsert"
                        }
                    }
                ],
                "responses": {
        ...
        "/appointments/post": {
            "post": {
                ...
                "summary": "PostWithLicenseAndDNI appointment",
                "parameters": [
                    {
                        "type": "string",
                        "description": "token",
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.appointmentPost"
                        }
                    }
                ],
                "responses": {
